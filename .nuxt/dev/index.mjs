...
import { renderToString } from 'file://E:/VUE%20projects/avtotest/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://E:/VUE%20projects/avtotest/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://E:/VUE%20projects/avtotest/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://E:/VUE%20projects/avtotest/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://E:/VUE%20projects/avtotest/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://E:/VUE%20projects/avtotest/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://E:/VUE%20projects/avtotest/node_modules/vue/index.mjs';
import { createHooks } from 'file://E:/VUE%20projects/avtotest/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://E:/VUE%20projects/avtotest/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://E:/VUE%20projects/avtotest/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/VUE%20projects/avtotest/node_modules/unstorage/dist/index.mjs';
...
import { SourceMapConsumer } from 'file://E:/VUE%20projects/avtotest/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://E:/VUE%20projects/avtotest/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://E:/VUE%20projects/avtotest/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://E:/VUE%20projects/avtotest/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://E:/VUE%20projects/avtotest/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"E:/VUE projects/avtotest/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/VUE projects/avtotest","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/VUE projects/avtotest/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/VUE projects/avtotest/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/VUE projects/avtotest/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:/VUE projects/avtotest/.data/kv"}));
...
const _iQ50QVDgrfl6ugYqzd8o9jMT5FqWYBXVx8vxdplTs = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/VUE projects/avtotest";
...
const _8HEdznDwW1xBDv3QnrH9TLbOykKRF5xcQTl0czqr0Bo = (nitroApp) => {
...
const plugins = [
  _iQ50QVDgrfl6ugYqzd8o9jMT5FqWYBXVx8vxdplTs,
...
const _f7IU4w = eventHandler((event) => {
...
const getServerEntry = () => import('file://E:/VUE%20projects/avtotest/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://E:/VUE%20projects/avtotest/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
